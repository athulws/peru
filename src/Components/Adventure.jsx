            ...
            <div className="row">
                ...
                <div className="col-xl-8 col-lg-6 col-md-6 col-sm-12">
                    <div className="adventure-content">
                        ...
                        <h2 className="mb-4 adventure-headings">ADVENTURES TO PERU MADE MY TRIP</h2>
                        <h2 className="mb-4 adventure-headings">EXTRAORDINARY, BLENDING EXPERT PLANNING</h2>
                        <h2 className="mb-4 adventure-headings">AND OUTSTANDING SERVICE FOR AN</h2>
                        <h2 className="mb-4 peruvian">UNFORGETTABLE PERUVIAN ADVENTURE!</h2>
